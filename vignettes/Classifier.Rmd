...
So as we can see, in this toy dataset, we classify two samples as ERG, one as ETV, two Other and one unclassified since we required the high threshold of 0.8 for Other.
